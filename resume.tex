...
\newcommand{\resumeItemListStart}{\begin{itemize}[rightmargin=0.11in]\vspace{-1pt}}
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Huge Jeremy Smart \vspace{2pt}} & % row = 1, col = 1
  Location: Rochester, NY \\ % row = 1, col = 2
  % \href{https://jane-doe.com}{\uline{jane-doe.com}} $|$ % row = 2, col = 1
  \href{https://linkedin.com/in/jcsmart}{\uline{LinkedIn}} $|$ % row = 2, col = 1
  \href{https://github.com/Qelxiros}{\uline{GitHub}} & % row = 2, col = 2
  % \href{https://leetcode.com/jane-doe}{\uline{Leetcode}} & % row = 2, col = 1
  Email: \href{mailto:jcs1000@rit.edu}{\uline{jcs1000@rit.edu}} $|$ % row = 2, col = 2
  Mobile: (317) 508-2585 \\ % row = 2, col = 2
\end{tabular*}
%--------------------------------------------
...
\section{Technical Skills}
  \resumeHeadingListStart{}
    \resumeSectionType{Languages}{ }{Rust, C/C++, C\#, Java, Python, JavaScript/TypeScript, SQL, Bash}
    \resumeSectionType{Tools}{}{git/GitHub, Proxmox, Kubernetes, Ceph, Ansible, Docker/Podman, SSH, Selenium, Linux}
...
\section{Projects}
  \resumeHeadingListStart{}
    \resumeTrioHeading{\href{https://github.com/Qelxiros/lazybar}{\uline{Lazybar}}}{Rust, Linux, git, GitHub}{}
      \resumeItemListStart{}
        \resumeItem{Created custom X11 status bar for personal use}
        \resumeItem{Utilized asynchronous code and event-driven APIs to minimize power consumption}
        \resumeItem{Interfaced with several aspects of the Linux kernel to gather and display data}
        \resumeItem{6500+ downloads and counting}
      \resumeItemListEnd{}

      \resumeTrioHeading{\href{https://github.com/Qelxiros/Chess--}{\uline{Chess--\---}}}{C\#, .NET, Monogame, git, GitHub}{}
      \resumeItemListStart{}
        \resumeItem{Adapted chess for a custom arcade cabinet}
        \resumeItem{Modified a classically square game to fit the vertical ultrawide monitor}
      \resumeItemListEnd{}

      \resumeTrioHeading{\href{https://github.com/Qelxiros/semantle}{\uline{Semantle}}}{Rust, C, CUDA, git, GitHub, SSH}{}
      \resumeItemListStart{}
        \resumeItem{Built an automatic solver for Semantle, an online word game}
        \resumeItem{Replicated Semantle experience in a terminal user interface}
        \resumeItem{Deployed helpful command line features to improve the solving experience}
        \resumeItem{Explored brute-force optimizations using GPU acceleration}
      \resumeItemListEnd{}

      \resumeTrioHeading{\href{https://github.com/Qelxiros/AetherBot}{\uline{AetherBot}}}{Java, Maven, Podman, git, GitHub, Selenium}{}
      \resumeItemListStart{}
        \resumeItem{Developed a Java bot to play BombParty, an online word game}
        \resumeItem{Containerized the bot for better portability}
        \resumeItem{Employed randomness and subtle delays to maintain the appearance of a human}
      \resumeItemListEnd{}
  \resumeHeadingListEnd{}
%--------------------------------------------
...
\section{Experience}
\resumeHeadingListStart{}
    \resumeQuadHeading{Vice President and Systems Administrator}{September 2022 -- Present}
    {Computer Science House @ RIT}{Rochester, NY}
    \resumeItemListStart{}
      \resumeItem{Act as first point of contact for questions and concerns from members}
      \resumeItem{Organize and oversee the process by which new members are screened, accepted, welcomed, and evaluated}
      \resumeItem{Maintain and expand OKD, Proxmox, and Ceph clusters across three physical locations and \$170,000+ of hardware}
    \resumeItemListEnd{}
  \resumeQuadHeading{Box Office Associate}{Summers 2022, 2023}
  {Interlakes Theatre}{Meredith, NH}
    \resumeItemListStart{}
      \resumeItem{Collaborated with colleagues to deliver a seamless customer service experience to patrons}
      \resumeItem{Assisted customers with various tasks both in person and over the phone}
    \resumeItemListEnd{}

  \resumeQuadHeading{Instructor}{November 2019 -- May 2022}
  {Mathnasium}{Carmel, IN}
    \resumeItemListStart{}
      \resumeItem{Tutored students ages 4 ‑ 18 in math concepts ranging in difficulty from addition to calculus}
      \resumeItem{Cooperated with other instructors to complete tasks efficiently and to ensure continuity of education}
    \resumeItemListEnd{}
\resumeHeadingListEnd{}
%---------------------------------------------
...
\section{Education}
  \resumeHeadingListStart{}
    \resumeQuadHeading{Rochester Institute of Technology}{May 2026}
    {Bachelor of Science in Computer Science, GPA: 3.5}{Rochester, NY}
    \footnotesize{Accelerated Bachelor's/Master's Program with Mathematics Minor}
  \resumeHeadingListEnd{}
%---------------------------------------------
